...
/// The embedded nuclide data JSON, generated by `scripts/merge_dataset.py`.
...
/// Build the database from extracted nuclear data (746 nuclides).
...
mod tests {
    ...
    fn extracted_database_loads() {
        ...
        assert!(db.len() > 700, "expected 700+ nuclides, got {}", db.len());
    }
